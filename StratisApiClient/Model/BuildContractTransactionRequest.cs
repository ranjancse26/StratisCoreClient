...
namespace StratisApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
  public class BuildContractTransactionRequest {
    /// <summary>
    /// Gets or Sets Sender
    /// </summary>
    ...
    /// </summary>
    /// <value>The fee for the transaction in STRAT (or a sidechain coin).</value>
    ...
    /// </summary>
    /// <value>The password for the wallet containing the funds for the transaction.</value>
