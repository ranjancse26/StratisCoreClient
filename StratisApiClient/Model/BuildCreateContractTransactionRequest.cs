...
namespace StratisApiClient.Model
{
  ...
  public class BuildCreateContractTransactionRequest {
    ...
    /// </summary>
    /// <value>The amount of STRAT (or the sidechain coin) to send to the smart contract address on creation.</value>
    ...
    /// </summary>
    /// <value>The fees in STRAT (or the sidechain coin) to cover the smart contract creation transaction.</value>
    ...
    /// </summary>
    /// <value>The smart contract bytecode.</value>
    ...
    /// </summary>
    /// <value>The gas price to charge when the smart contract constructor is run by the miner mining the creation transaction.</value>
    [DataMember(Name="gasPrice", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "gasPrice")]
    public long? GasPrice { get; set; }

    /// <summary>
    /// The maximum amount of gas that can be spent executing this transaction.  This limit cannot be exceeded when the method is   run by the miner mining the creation transaction. If the gas spent exceeds this value,   execution of the smart contract stops.
    /// </summary>
    /// <value>The maximum amount of gas that can be spent executing this transaction.  This limit cannot be exceeded when the method is   run by the miner mining the creation transaction. If the gas spent exceeds this value,   execution of the smart contract stops.</value>
